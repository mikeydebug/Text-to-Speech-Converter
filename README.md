...
A sleek and interactive Text-to-Speech Web App built with HTML, CSS, and JavaScript. Powered by the Web Speech API, this project converts written text into natural-sounding speech with multiple voice options. Ideal for learning DOM manipulation, APIs, and accessibility features in modern web development.
